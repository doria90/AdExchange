...
public class LosCaparos extends Agent 
{
	...
	/*New variable that counts the number of campaigns our agent won. 
	 * The agent will stop going part at the auction once he won 3 campaigns 
	 * LOSCAPAROS
	 
	private double numOfCampaigns; */
	...
	private void handleICampaignOpportunityMessage(
		...
		if (numOfCampaigns < 3){
			...
			cmpBidMillis = random.nextInt((int)cmpimps/8); //was 1
		}
		else{
			cmpBidMillis = 1; //was cmpimps+1;
			//System.out.println("\t\t!!!!!!!!!!!!!!!!!!!!Num of Campaings: "+numOfCampaigns+"!!!!!!!!!!!!!!!!");
		}
		 */
		...
		if (adNetworkDailyNotification != null) {
			...
			/*ucsBid = 0.21; //was 0.21 LOSCAPAROS*/
	...
	private class SitesStatistic
	{
		...
		private class constSiteStatistics
		{
			String name;
		...
		public SitesStatistic()
		{
			...
			newsSites=constSiteStatistics{yahoo,cnn,nytimes,hfngtn,msn,fox};
			shoppingSites=constSiteStatistics{amazon,ebay,walmart,target,bestbuy,sears};
			webInformationSites=constSiteStatistics{webmd,ehow,ask,tripadvisor,cnet,weather};
		}
	
		public void todayStatistics(AdxPublisherReport adxPublisherReport)
		{
